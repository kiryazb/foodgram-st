...
TEST_USERS = [
    {"email": "admin@example.com", "username": "admin", "password": "adminpass", "is_superuser": True,
     "is_staff": True},
    ...
    def handle(self, *args, **kwargs):
        ...
        for user in users:
            for other_user in users:
                if user != other_user and not Subscription.objects.filter(user=user, author=other_user).exists():
